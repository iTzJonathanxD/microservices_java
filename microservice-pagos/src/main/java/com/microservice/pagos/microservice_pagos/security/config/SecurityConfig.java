package com.microservice.pagos.microservice_pagos.security.config;

import com.microservice.pagos.microservice_pagos.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers("/auth/**", "/swagger-ui/**", "/api-docs", "api-docs/**", "/docs","/pagos/reporte","/ws-pagos", "/graphiql", "/graphiql/**").permitAll()
