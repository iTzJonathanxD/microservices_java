package com.uleam.microservice_tipoPago.security.config;

import com.uleam.microservice_tipoPago.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers("/auth/**", "/swagger-ui/**", "/api-docs", "api-docs/**", "/docs","/tipos-pago/reporte","/ws-tipos-pago", "/graphiql", "/graphiql/**", "/graphql/**").permitAll()
